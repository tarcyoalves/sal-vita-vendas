...
export const emailMarketingRouter = router({
  ...
  previewAudience: publicProcedure.query(async () => {
  ...
  dispatchCampaign: publicProcedure
  ...
  // ── Sequences (Drip) ──────────────────────────────────────────────────────
  getSequences: publicProcedure.query(async () => {
  ...
  toggleSequence: publicProcedure
  ...
  runSequencesCronNow: publicProcedure.mutation(async () => {
    const result = await processSequenceEnrollments(100);
    return result;
  }),

  // ── Automation Rules Engine ───────────────────────────────────────────────
  getAutomationRules: publicProcedure.query(async () => {
  ...
  deleteAutomationRule: publicProcedure
  ...
  removeSuppression: publicProcedure

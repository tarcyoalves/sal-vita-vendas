...
```bash
INIT=$(node "/home/user/sal-vita-vendas/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/sal-vita-vendas/.claude/get-shit-done/bin/gsd-tools.cjs" commit \

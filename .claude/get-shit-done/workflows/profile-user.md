...
Key references:
- @/home/user/sal-vita-vendas/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/home/user/sal-vita-vendas/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/user/sal-vita-vendas/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/user/sal-vita-vendas/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/user/sal-vita-vendas/.claude/get-shit-done/USER-PROFILE.md" "/home/user/sal-vita-vendas/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/user/sal-vita-vendas/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/user/sal-vita-vendas/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/home/user/sal-vita-vendas/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/user/sal-vita-vendas/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/user/sal-vita-vendas/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/user/sal-vita-vendas/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/user/sal-vita-vendas/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/user/sal-vita-vendas/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/user/sal-vita-vendas/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/user/sal-vita-vendas/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/user/sal-vita-vendas/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /home/user/sal-vita-vendas/.claude/CLAUDE.md
```

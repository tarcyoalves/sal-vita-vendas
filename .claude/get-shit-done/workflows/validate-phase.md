...
```
Agent(
  prompt="Read /home/user/sal-vita-vendas/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/sal-vita-vendas/.claude/get-shit-done/templates/VALIDATION.md`

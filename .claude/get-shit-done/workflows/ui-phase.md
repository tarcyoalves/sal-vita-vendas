...
```markdown
Read /home/user/sal-vita-vendas/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/sal-vita-vendas/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/sal-vita-vendas/.claude/agents/gsd-ui-checker.md for instructions.

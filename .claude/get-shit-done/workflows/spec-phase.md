...
```bash
INIT=$(node "/home/user/sal-vita-vendas/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/user/sal-vita-vendas/.claude/get-shit-done/templates/spec.md.

...
Use template from `/home/user/sal-vita-vendas/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/sal-vita-vendas/.claude/get-shit-done/templates/UI-SPEC.md`

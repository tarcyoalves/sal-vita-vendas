...
<reference>
@/home/user/sal-vita-vendas/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/sal-vita-vendas/.claude/get-shit-done/references/user-profiling.md` to load:

...
<required_reading>
@/home/user/sal-vita-vendas/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/sal-vita-vendas/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/sal-vita-vendas/.claude
                  → checks /home/user/sal-vita-vendas/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/sal-vita-vendas/.claude/get-shit-done
                  → writes to /home/user/sal-vita-vendas/.claude/get-shit-done/hooks/
...
@/home/user/sal-vita-vendas/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/sal-vita-vendas/.claude/get-shit-done/references/common-bug-patterns.md

...
Reference full template: `/home/user/sal-vita-vendas/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/sal-vita-vendas/.claude/get-shit-done/templates/state.md`.

...
<execution_context>
@/home/user/sal-vita-vendas/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user/sal-vita-vendas/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
